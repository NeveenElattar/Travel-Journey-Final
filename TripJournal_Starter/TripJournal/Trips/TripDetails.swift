...
#Preview {
            ...
            trip: Trip(
                ...
                events: [
                    Event(
                        ...
                        note: "Beautiful city!",
                        date: Date(),
                        location: Location(latitude: 35.6762, longitude: 139.6503, address: "Tokyo, Japan"),
                        medias: [],
                        transitionFromPrevious: "Flight from home"
                    )
                ]
            ),
            addAction: .constant({}),
    ...
    .environment(\.journalService, LiveJournalService())
}
